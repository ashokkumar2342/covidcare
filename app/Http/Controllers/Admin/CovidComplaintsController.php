...
class CovidComplaintsController extends Controller
{
    ...
    {   
      ...
      // event(new SmsEvent($request->mobile_no,'Your complaint No. '.$CovidComplaints->id.' have forwarded to '.$OfficerComplaint->name.' '.$OfficerComplaint->designation.' '.$OfficerComplaint->mobile_no.'. District Administration Jhajjar')); 
      
      // event(new SmsEvent($OfficerComplaint->mobile_no,'Complaint No. '.$CovidComplaints->id.' received from '.$CovidComplaints->name.' '.$CovidComplaints->mobile_no.'. District Administration Jhajjar')); 
      // if ($OfficerComplaint->mobile_no!=null) {
      //     event(new SmsEvent($OfficerComplaint->alternate_mobile_no,'Complaint No. '.$CovidComplaints->id.' received from '.$CovidComplaints->name.' '.$CovidComplaints->mobile_no.'. District Administration Jhajjar'));
      // }
